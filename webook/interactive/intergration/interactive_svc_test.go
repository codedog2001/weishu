...
import (
	...
	"xiaoweishu/webook/interactive/intergration/startup"
...
type InteractiveTestSuite struct {
	suite.Suite
	db  *gorm.DB
	rdb redis.Cmdable //用cmdable不是client
}
...
func (s *InteractiveTestSuite) TestIncreaseReadCnt() {
	testCases := []struct {
		name     string
